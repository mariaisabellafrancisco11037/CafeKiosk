    ...
    <section class="ck-card">
      <div class="ck-toolbar">
        ...
        <div class="ck-actions">
          <button class="ck-btn" id="inviteUser">Invite Staff to Sign Up</button>
...
<div class="ck-modal" id="inviteModal">
  <div class="ck-dialog" style="max-width:560px">
    <div class="ck-toolbar"><h2>Invite Staff</h2><button class="ck-btn" id="closeInvite" type="button">Close</button></div>
    <form id="inviteForm" class="ck-grid">
      <div class="ck-field"><label>Staff Email</label><input class="ck-input" id="inviteEmailInput" type="email" required placeholder="staff@example.com"></div>
      <div class="ck-field"><label>Role</label><select class="ck-select" id="inviteRoleInput"><option value="Staff">Staff</option><option value="Manager">Manager</option><option value="Admin">Admin</option></select></div>
      <button class="ck-btn primary" type="submit">Create Invitation</button>
      <div id="inviteMessage" class="ck-muted" style="min-height:20px"></div>
      <div id="inviteResult" style="display:none">
        <div class="ck-field"><label>Staff Sign Up Link</label><input class="ck-input" id="inviteLink" readonly></div>
        ...
        <div class="ck-muted" style="margin-top:8px">Send this link only to the staff member you invited. It expires automatically.</div>
      </div>
    </form>
  </div>
</div>
...
<script src="../Assets/js/staff-invite.js"></script>
