...
<head>
  ...
  <link rel="stylesheet" href="../Assets/css/signup.css?v=2">
...
<body>
  <main class="signup-page">
    <section class="signup-card">
      ...
      <p class="signup-subtitle">Register as the cafe owner. This creates a new CafeKiosk workspace and your Admin account.</p>
      ...
      <form id="ownerSignupForm" class="signup-grid" autocomplete="on">
        ...
        <div class="signup-note">After signup, save your generated <strong>Cafe ID</strong>. Staff accounts are created using an invitation generated by the owner/Admin.</div>
        <div class="signup-field full">
  ...
  <script src="../Assets/js/signup.js?v=3"></script>
